...
F_CK = Fest(destination_ppp.km)
F_CK.csr <- envelope(destination_ppp.km, Fest, nsim = 249)
plot(F_CK.csr)

F_CK = Fest(origin_ppp.km)
F_CK.csr <- envelope(destination_ppp.km, Fest, nsim = 249)
plot(F_CK.csr)
```
...
![TNKDEOriginChangi](images/tnkde_origin_changi.gif) ![TNKDEOriginChangi](images/tnkde_destination_changi.gif)
...
![TNKDEOriginWoodlands](images/tnkde_origin_woodlands.gif) ![TNKDEDestinationWoodlands](images/tnkde_destination_woodlands.gif)
...
![TNKDEOriginTown](images/tnkde_origin_town.gif) ![TNKDEDestinationTown](images/tnkde_destination_town.gif)
