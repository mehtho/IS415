...
The rule of "Do not repeat yourself" applies in R too. I have learnt from my previous takehome exercise and will use functions for repeated analysis to avoid duplicated code. I use inverse distance here since the size of polygons differ greatly. 
