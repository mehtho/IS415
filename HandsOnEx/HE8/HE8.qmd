...
Relationships intrinsically different across space
 -    The variation is actually dependent on space
 
Model misspecification


#### Other Definitions
Spatially non-stationarity: 
 -    Same stimulus but different response in different parts of the study region

Global models:
 -    Location independent, spatially stationary
 
 Local models:
 -    Not global, expected from spatial data
...
#### Calibration of GWR
Use local weighted least squares
 -    Give weights based on the locations, following 1st law of geography
...
Terminology
 -    Condition Number: Evaluates local collinearity. If strong local collinearity, result can be unstable. >30 may be unreliable
